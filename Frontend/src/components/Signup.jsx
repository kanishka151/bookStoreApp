...
function Signup() {
  ...
  const onSubmit = async (data) => { //data ke andar name,email,password hai
    const userInfo={
  ...
  <div class="modal-box">
    ...
    <div className='mt-4 space-y-2'>
        <span>Email</span>
        <br/>
        <input type="email" placeholder='Enter your email' className='w-80 px-3 py-1 border rounded-md outline-none' {...register("EmailID", { required: true })}/>
